...
export default function Weather (props) {
  ...
  function correctDataFormat(data) {
    const formatData = {
      ...
      sunrise: new Date(data.sunrise * 1000).toLocaleTimeString('en-US',{ hour: '2-digit', minute: '2-digit' }), //to hour & min
      sunset: new Date(data.sunset * 1000).toLocaleTimeString('en-US',{ hour: '2-digit', minute: '2-digit' })    //to hour & min
    };
    return formatData;
  }
